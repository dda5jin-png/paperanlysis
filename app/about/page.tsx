    ...
    <main>
      <Container className="py-16 max-w-3xl">
        ...
        <div className="mt-8 prose-ko">
          ...
          <h2>우리가 만드는 것</h2>
          <p>
            분석 도구, 논문 아티클, 논문 가이드를 함께 제공합니다. 도구는 업로드한 PDF를 섹션 단위로 정리해주고, 아티클은 실제로 막히는
            지점을 문제 해결형으로 풀어주며, 가이드는 논문 준비 전체 흐름의 기준점을 제시합니다. 세 영역이 자연스럽게 연결되어, 읽은 내용을
            내 연구에 바로 적용할 수 있도록 돕는 것을 목표로 합니다.
          </p>
          <h2>연락</h2>
          <p>
            제안, 버그 제보, 콘텐츠 요청은{" "}
