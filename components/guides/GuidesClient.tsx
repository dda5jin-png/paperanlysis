...
const stageLinks: Record<string, { href: string; label: string }[]> = {
  "주제 설정": [
    { href: "/resources/부동산-석사-논문이-정체가-모호하다는-평가를-받는-이유", label: "논문 정체성이 모호해지는 이유" },
    { href: "/resources/같은-부동산-주제라도-논문이-완전히-달라지는-이유", label: "같은 주제라도 논문이 달라지는 이유" },
  ],
  "논문 구조 작성": [
      ...
      <section className="border-b border-ink-200 bg-white">
        <Container className="py-12 lg:py-16">
          ...
          <p className="mt-4 max-w-3xl leading-7 text-ink-700">
            ...
            실제로 읽고 해결하는 콘텐츠는 <strong>자료실</strong>에 쌓고, 이곳에서는 지금 내 위치와 다음 단계만
            빠르게 확인하도록 구성했습니다.
          </p>
